...
export const Home = () => {
	...
	const [contacts, setContacts] = useState([])
	  ...
	  useEffect (() => {
			fetch("https://assets.breatheco.de/apis/fake/contact/agenda/my_super_agenda_11", {
				method: "GET",
				headers: {
	...
	<div className="row">
		...
		<div className="card" style={{maxWidth:"1400px"}} key={contacts.id}>
			<div className="row">
			<div className="col-md-4">
			<img src="https://static.vecteezy.com/system/resources/thumbnails/009/734/564/small/default-avatar-profile-icon-of-social-media-user-vector.jpg" className="img-fluid" alt={"${contacts.id}"} /> 
			</div>
